...
public class TodayItemsAdapter extends RecyclerView.Adapter<TodayItemsAdapter.ViewHolder>{
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.amount.setText("Spent: Rs:"+data.getAmount());
    ...
    private void updatedata() {
        ...
        final TextView mItem = myView.findViewById(R.id.itemU);
        final EditText mAmount = myView.findViewById(R.id.amountU);
        final EditText mNote = myView.findViewById(R.id.notesU);
