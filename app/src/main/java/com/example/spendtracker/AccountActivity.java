...
public class AccountActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        logedInOn = findViewById(R.id.logedInOnA);
        name = findViewById(R.id.nameA);
        email = findViewById(R.id.emailA);
        logout = findViewById(R.id.logoutBtnA);
        profileImage  = findViewById(R.id.profile_imageA);
        ...
        usersRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                Glide.with(AccountActivity.this).load(snapshot.child("profilepicurl").getValue().toString()).into(profileImage);
